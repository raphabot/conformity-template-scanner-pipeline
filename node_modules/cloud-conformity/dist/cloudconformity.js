...
class CloudConformity {
    ...
    ;
    // Accounts API
    async createAnAWSAccount(name, environment, roleArn, externalId, costPackage, hasRealTimeMonitoring) {
        const data = {
            "data": {
                "type": "account",
                "attributes": {
    ...
    async createAnAzureSubscription(name, environment, subscriptionId, activeDirectoryId) {
        const data = {
            "data": {
                "type": "account",
                "attributes": {
    ...
    async createAGCPAccount(name, environment, projectId, projectName, serviceAccountUniqueId) {
        const data = {
            "data": {
                "type": "account",
                "attributes": {
    ...
    async scanATemplate(template, type, profileId, accountId) {
        const data = {
            "data": {
                "attributes": {
                    "type": type,
    ...
    async scanACloudFormationTemplate(template, profileId, accountId) {
        return (await this.scanATemplate(template, "cloudformation-template", profileId, accountId));
    }
    async scanATerraformTemplate(template, profileId, accountId) {
        return (await this.scanATemplate(template, "terraform-template", profileId, accountId));
    }
    async scanATemplateAndReturnAsArrays(template, type, profileId, accountId) {
    ...
    async scanACloudFormationTemplateAndReturAsArrays(template, profileId, accountId) {
        return await this.scanATemplateAndReturnAsArrays(template, "cloudformation-template", profileId, accountId);
    }
    async scanATerraformTemplateAndReturAsArrays(template, profileId, accountId) {

export declare class CloudConformity {
    ...
    createAnAccount(name: string, environment: string, roleArn: string, externalId: string, costPackage: boolean, hasRealTimeMonitoring: boolean): Promise<any>;
    ...
    scanACloudFormationTemplate(template: string, type?: string, profileId?: string, accountId?: string): Promise<any>;
    scanACloudFormationTemplateAndReturAsArrays(template: string, type?: string, profileId?: string, accountId?: string): Promise<{
        success: any[];
        failure: any[];
    }>;
